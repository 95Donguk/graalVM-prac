package com.example.demo.jmh_generated;
...
import com.example.demo.jmh_generated.JavaSimpleStreamBenchmark_jmhType;
public final class JavaSimpleStreamBenchmark_testMethod_jmhTest {
    ...
    public BenchmarkTaskResult testMethod_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            JavaSimpleStreamBenchmark_jmhType l_javasimplestreambenchmark0_0 = _jmh_tryInit_f_javasimplestreambenchmark0_0(control);
            ...
            while (control.warmupShouldWait) {
                blackhole.consume(l_javasimplestreambenchmark0_0.testMethod());
                if (control.shouldYield) Thread.yield();
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            testMethod_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_javasimplestreambenchmark0_0);
            ...
            if (control.isLastIteration()) {
                f_javasimplestreambenchmark0_0 = null;
            }
    ...
    public BenchmarkTaskResult testMethod_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            testMethod_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_javasimplestreambenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult testMethod_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            testMethod_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_javasimplestreambenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void testMethod_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, JavaSimpleStreamBenchmark_jmhType l_javasimplestreambenchmark0_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult testMethod_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            testMethod_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_javasimplestreambenchmark0_0);
            control.preTearDown();
    ...
    public static void testMethod_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, JavaSimpleStreamBenchmark_jmhType l_javasimplestreambenchmark0_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    JavaSimpleStreamBenchmark_jmhType f_javasimplestreambenchmark0_0;
    
    JavaSimpleStreamBenchmark_jmhType _jmh_tryInit_f_javasimplestreambenchmark0_0(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        JavaSimpleStreamBenchmark_jmhType val = f_javasimplestreambenchmark0_0;
        if (val == null) {
            val = new JavaSimpleStreamBenchmark_jmhType();
            f_javasimplestreambenchmark0_0 = val;
        }
        return val;
    }
